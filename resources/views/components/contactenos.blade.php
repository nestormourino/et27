    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-6">
                <h1 class="py-4 mx-auto text-4xl leading-8 font-bold" style="border-bottom: 4px solid #1e4a6d; text-align:center">CONTACTENOS</h1>
                <div class="grid grid-cols-1 lg:grid-cols-2 py-6 gap-6">
                    <div class="text-xl">
                        ...
                        <form id="contact-me" class="w-full mx-auto max-w-3xl bg-white text-gray-700 " action="{{route('contactanos.store')}}" method="POST">
                            @csrf
                            <h2 class="w-full my-2 text-3xl font-bold leading-tight">Escribenos un correo</h2>
                            <!-- name field -->
                    ...
                    <div class="">
                        <center>
                            <h1 class="w-full my-2 text-3xl font-bold leading-tight">Como llegar</h1>
