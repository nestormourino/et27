...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        Category::create([
            ...
            'link_image' => 'https://www.et27de18.com/images/primero.png',
        ...
        Category::create([
            ...
            'link_image' => 'https://www.et27de18.com/images/segundo.png',
            'description' => 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolores velit rerum sapiente vitae magnam fuga alias dolore quod odit suscipit odio, consequatur corrupti praesentium quas nesciunt reiciendis iusto. Velit, nisi?'
        ]);
        Category::create([
            'name' => '3er año',
            ...
            'link_image' => 'https://www.et27de18.com/images/tercero.png',
            'description' => 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolores velit rerum sapiente vitae magnam fuga alias dolore quod odit suscipit odio, consequatur corrupti praesentium quas nesciunt reiciendis iusto. Velit, nisi?'
        ]);
        Category::create([
            'name' => '4to año',
            ...
            'link_image' => 'https://www.et27de18.com/images/cuarto.png',
            'description' => 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolores velit rerum sapiente vitae magnam fuga alias dolore quod odit suscipit odio, consequatur corrupti praesentium quas nesciunt reiciendis iusto. Velit, nisi?'
        ]);
        Category::create([
            'name' => '5to año',
            ...
            'link_image' => 'https://www.et27de18.com/images/quinto.png',
            'description' => 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolores velit rerum sapiente vitae magnam fuga alias dolore quod odit suscipit odio, consequatur corrupti praesentium quas nesciunt reiciendis iusto. Velit, nisi?'
        ]);
        Category::create([
            'name' => '6to año',
            ...
            'link_image' => 'https://www.et27de18.com/images/sexto.png',
            'description' => 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolores velit rerum sapiente vitae magnam fuga alias dolore quod odit suscipit odio, consequatur corrupti praesentium quas nesciunt reiciendis iusto. Velit, nisi?'
        ]);
        Category::create([
